...
public enum Lang
{
    EXTRA_HEALTH_ADD_OVER_MAX("Extra-Health-Add-Over-Max", "&8<&cHealth&8> &7Unable to give &f{0} {1} &7extra max health as it would put them over the max extra health limit of &f{2} &7as defined in the config!"),
    EXTRA_HEALTH_ADDED("Extra-Health-Added", "&8<&9Health&8> &f{0} &7extra max health has been given to &f{1}"),

    EXTRA_HEALTH_REMOVED("Extra-Health-Removed", "&8<&9Health&8> &f{0} &7extra max health has been taken from &f{1}"),
    EXTRA_HEALTH_REMOVE_UNDER_ZERO("Extra-Health-Remove-Under-Zero", "&8<&cHealth&8> &7Unable to take &f{0} &7extra max health from &f{1} &7as it would put them under zero!"),

    EXTRA_HEALTH_SET_OVER_MAX("Extra-Health-Set-Over-Max", "&8<&cHealth&8> &7Unable to set extra max health for &f{0} &7to &f{1} &7as it would put them over the max extra health limit of &f{2} &7as defined in the config!"),
    EXTRA_HEALTH_SET_UNDER_ZERO("Extra-Health-Set-Under-Zero", "&8<&cHealth&8> &7Unable to set extra max health for &f{0} &7to &f{1} &7as it would put them under zero!"),
    ...
    ARGUMENT_MUST_BE_INTEGER("Argument-Must-Be-Integer", "&8<&cHealth&8> &f{0} &7must be an integer."),
    ARGUMENT_MUST_BE_DOUBLE("Argument-Must-Be-Double", "&8<&cHealth&8> &f{0} &7must be an number with or without decimal places."),
    NO_PERMISSION_COMMAND("No-Permission-Command", "&8<&cHealth&8> &7You do not have the required permission to perform this command: &f{0}");
    ...
    public void sendMessage(CommandSender sender, String... replacements)
    {
        ...
        Arrays.stream(messages).forEach((message) -> sender.sendMessage(StringUtil.translate(message)));
    }
